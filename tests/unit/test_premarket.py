...
def test_event_blocked_propagates():
    df = synthetic_daily(date(2024, 1, 31), n=220)
    h4 = synthetic_h4(datetime(2024, 1, 31, 14, 30, tzinfo=timezone.utc), n=220)
...
def test_seasonal_multiplier_applied():
    df = synthetic_daily(date(2024, 1, 15), n=220)
    h4 = synthetic_h4(datetime(2024, 1, 15, 14, 30, tzinfo=timezone.utc), n=220)
